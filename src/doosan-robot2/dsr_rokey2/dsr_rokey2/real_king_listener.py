...
# (5) [NEW] Cup Grip Sequence - [동료 수정 사항 반영]
...
# (6) [NEW] Topping Sequence - [동료 수정 사항 반영 및 문법 오류 수정]
def sequence_topping():
    ...
    # [FIX] 문법 오류 수정 (VEL = 100, ACC = 100 -> VEL, ACC = 100, 100)
    VEL = 100
    ACC = 100
