...
# ==========================================================
# 3. 로봇 동작 시퀀스 (test(3).py 최신 로직 반영)
# ==========================================================
...
# (3) Drip + Corn (HOT) - [동료 test(3).py 로직 반영]
...
# (5) [NEW] Cup Grip Sequence - [test(3).py 최신 좌표]
...
# (6) [NEW] Topping Sequence - [test(3).py 최신 좌표 및 로직 추가]
